...
dek: What the Province Produces, What It Exports, and What It Needs From Everyone Else
pubDate: 2026-02-17
topic: Economy
...
featured: true
draft: false
description: "A detailed data foundation for understanding Alberta's role in Confederation — grounding policy debate in measurable economic reality, with particular attention to interprovincial trade flows and fiscal transfers."
---
...
Articles work better with structured feedback than open comment threads. If something is wrong, unclear, or worth discussing, use the route that fits best.

```{=html}

    <h3>Report An Error</h3>
    <p>Use this when a number, source, or factual claim needs correction.</p>
    <a href="../pages/contact.html">Send a correction →</a>

    <h3>Send A Note</h3>
    <p>Use this for responses, nuance, or follow-up questions about the article.</p>
    <a href="../pages/contact.html">Send a note →</a>

    <h3>Keep Reading</h3>
    <p>This article is part of the Alberta in Context sequence.</p>
    <a href="./texas-of-the-north.html">Read the next article →</a>
